...
void OLED_ShowChar(uint8_t x,uint8_t y,uint8_t chr,uint8_t fontsize,uint8_t Mode);
void OLED_ShowString(uint8_t x,uint8_t y,uint8_t *chr,uint8_t fontsize,uint8_t Mode);
void OLED_ShowString_Rowcentering(uint8_t y,uint8_t *chr,uint8_t fontsize,uint8_t Mode);
...
void OLED_ShowPicture(uint8_t x,uint8_t y,uint8_t fontsizex,uint8_t fontsizey,const uint8_t BMP[],uint8_t Mode);
...
void OLED_SendBytes_Poll( uint8_t* Bytes,uint8_t CommandOrData, uint8_t fontsize);
void OLED_SendBytes_DMA( uint8_t* Bytes,uint8_t CommandOrData, uint8_t fontsize);
